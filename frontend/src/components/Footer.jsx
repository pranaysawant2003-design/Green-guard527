      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <span className="text-2xl font-bold font-display">GreenGuard</span>
            </div>
            <p className="text-gray-300 mb-6 max-w-md">
              Empowering individuals to become stewards of our planet through technology, community, and meaningful action.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#explore" className="text-gray-300 hover:text-emerald-400 transition-colors">Explore</a></li>
              <li><a href="#garden" className="text-gray-300 hover:text-emerald-400 transition-colors">Garden</a></li>
        ...
        <div className="border-t border-gray-700 pt-8 text-center">
          <p className="text-gray-400">
            © 2024 GreenGuard. All rights reserved. Made with ❤️ for our planet.
          </p>
        </div>
      </div>
    </footer>
